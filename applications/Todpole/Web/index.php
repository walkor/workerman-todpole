...
<html>
	...
	<body>
		...
		<?php if(!is_mobile()){?>
			...
			<section id="wtf">
				<h2>powered&nbsp;by&nbsp;<a rel="external" href="http://workerman.net/workerman-todpole" target="_blank">workerman</a> &nbsp;&nbsp;&nbsp;&nbsp;感谢<a href="http://rumpetroll.com/">rumpetroll.com</a>提供的界面</h2>
			</section>
			</aside>
			<?php }?>
            <aside id="frogMode">
